...
- [x] 3.4. Wire config into `setup.js` (shadows, pixel ratio)
- [x] 3.5. Add loading sequence with font + GPU detection
...
- [x] 7.2. Write unit tests for pure logic
- [x] 7.3. Write shader validation tests
